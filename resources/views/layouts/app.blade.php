...
<body>
    <div class="container">
        <nav class="sidebar">            
            <div>
                <div class="sidebar__logo">
                    ...
                    <h2 class="sidebar__logo-header"> {{ config('app.name', 'Zoi Users') }}</h2>    
                </div>
                <ul class="side-nav">
                    <span class="side-nav__header">Main Menu</span>
                    <li class="side-nav__item right_side_nav_switch_btn side-nav__item-active" data-href="{{ route('dashboard') }}"> 
                    ...
                    <li class="side-nav__item right_side_nav_switch_btn"  data-href="{{ route('profile.edit') }}">
                    ...
                    <li class="side-nav__item right_side_nav_switch_btn" data-href="{{ route('users.index') }}">
                        <svg width="22" height="23" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="side-nav__item right_side_nav_switch_btn" data-href="{{ route('privileges.index') }}">
                        <svg width="22" height="23" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="side-nav__item right_side_nav_switch_btn" data-href="{{ route('roles.index') }}">
                        <svg width="22" height="23" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <ul class="side-nav">
                    ...
                    <li class="side-nav__item right_side_nav_switch_btn" data- href="{{ route('account.index') }}">
                        <svg width="22" height="23" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2.2915 12.6367V11.0509C2.2915 9.15336 3.84067 7.60419 5.73817 7.60419H16.2615C18.159 7.60419 19.7082 9.15336 19.7082 11.0509V12.3709H17.8565C17.3432 12.3709 16.8757 12.5725 16.5365 12.9208C16.1515 13.2967 15.9315 13.8375 15.9865 14.415C16.069 15.405 16.9765 16.1292 17.9665 16.1292H19.7082V17.22C19.7082 19.1175 18.159 20.6667 16.2615 20.6667H11.2382" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M2.2915 11.8758V7.6867C2.2915 6.59587 2.96067 5.62416 3.97817 5.23916L11.2565 2.48916C12.3932 2.05833 13.6123 2.90169 13.6123 4.12085V7.60418" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M20.6787 13.306V15.1944C20.6787 15.6985 20.2754 16.111 19.7621 16.1293H17.9654C16.9754 16.1293 16.0679 15.4052 15.9854 14.4152C15.9304 13.8377 16.1504 13.2968 16.5354 12.921C16.8746 12.5727 17.3421 12.371 17.8554 12.371H19.7621C20.2754 12.3894 20.6787 12.8018 20.6787 13.306Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <ul class="side-nav">
                <li class="side-nav__item last-item right_side_nav_switch_btn"  data- href="{{ route('logout') }}"  onclick="event.preventDefault();  document.getElementById('logout-form').submit();">
        ...
        <main class="main-content">
            <div class="top-container">
                <div action="#" class="left-nav-content">
                ...
                <div class="user-nav" >
                    ...
                    <div class="nav-item dropdown"id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('logout') }}"
                                     ...
                                     <a  class="dropdown-item right_side_nav_switch_btn " data-href="{{ route('profile.edit') }}">Edit Profile</a>  
    ...
    <script>
        $('body').on('click', '.right_side_nav_switch_btn', function(e) {
            e.preventDefault(); // Prevent the default click behavior
            
            let th = $(this);
            let url_href = th.attr('data-href');
            
            if (typeof url_href === "undefined" || url_href.length === 0) {
                console.log('URL Validation error ');
                return;
            }
            
            $('.right_side_nav_switch_btn').removeClass('side-nav__item-active');
            th.addClass('side-nav__item-active');
            ...
            $.ajax({
                ...
                let sectionContent = $(response).find('.body_content').html(); 
                $('.body_content').html(sectionContent);
                },
        ...
        $(document).ready(function() {
            $('body').on('click', '.user_ajax_call', function(e) {
